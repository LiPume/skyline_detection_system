...
- **模型切换与视频切换**：支持 YOLO-World-V2（开放词汇）/ YOLOv8-Base / YOLOv8-Car / YOLOv8-VisDrone 四种模型，PT / ONNX 双运行时
...
- **PT / ONNX runtime 双路径**：PyTorch（YOLO-World-V2、YOLOv8-Base）与 ONNX（YOLOv8-Car、YOLOv8-VisDrone）两条路径统一向前端暴露 timing 字段；TensorRT 为后续扩展方向
